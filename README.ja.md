...
**[Infinite Flight](https://infiniteflight.com) パイロットのための、美しくプライベートなフライトログダッシュボード。**
...
Infinite Flight のフライトログを、美しいチャート、世界地図、3D 地球儀に変換するシンプルでプライベートなダッシュボードです。**データは端末から一切外に出ません** — サインアップ不要、アップロードなし、トラッキングなし。
