...
### → [**打开飞行纪录可视化面板**](https://aki-12138.github.io/Infinite-Flight-Dashboard/) ←
...
就这么简单。第一次打开时，面板是空的，会显示两个按钮 — **Import CSV**（已有飞行记录的人）或 **Add your first flight**（从第一条记录开始的人）。下面这份指南会逐项介绍进入之后能做的事情。
...
选择时面板实时更新。**Comparing** 卡基于你当前的 Year 选择显示年度同比增减。
